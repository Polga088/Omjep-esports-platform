 ...
 */
export type MotionConflictKeys = 'onDrag' | 'onDragStart' | 'onDragEnd' | 'onDragOver' | 'onDragEnter' | 'onDragLeave' | 'onDrop' | 'onAnimationStart' | 'onAnimationEnd' | 'onAnimationIteration';
export type OmitMotionConflicts<T> = Omit<T, MotionConflictKeys>;
//# sourceMappingURL=omit-motion-conflicts.d.ts.map