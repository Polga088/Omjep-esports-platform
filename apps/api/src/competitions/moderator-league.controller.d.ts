...
export declare class ModeratorLeagueController {
    private readonly moderatorLeague;
    constructor(moderatorLeague: ModeratorLeagueService);
    ...
    createMatch(id: string, dto: CreateModeratorMatchDto): Promise<{
        message: string;
        match: {
            competition: {
                id: string;
    ...
    validateScore(id: string, body: ModeratorValidateScoreDto): Promise<{
        message: string;
        match: {
            competition: {
                id: string;
...
//# sourceMappingURL=moderator-league.controller.d.ts.map