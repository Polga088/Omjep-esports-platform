      ...
      <AnimatePresence custom={direction} mode="wait" initial={false}>
        {!isHub ? (
          <motion.div
            ...
            className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(ellipse_70%_60%_at_50%_50%,rgba(15,23,42,0)_32%,rgba(15,23,42,0.16)_84%)] dark:bg-[radial-gradient(ellipse_70%_60%_at_50%_50%,rgba(0,0,0,0)_30%,rgba(0,0,0,0.68)_85%)]"
            aria-hidden
          />
        ) : null}
      </AnimatePresence>
