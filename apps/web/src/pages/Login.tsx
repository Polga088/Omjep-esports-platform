  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 relative">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] rounded-full bg-[#00D4FF]/4 blur-[100px]" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl border border-white/10 bg-[#0D1221] shadow-2xl shadow-black/50 p-8">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-[#00D4FF] to-[#0099BB] shadow-lg shadow-[#00D4FF]/25 mb-4">
              <Zap className="w-7 h-7 text-[#0A0E1A]" fill="currentColor" />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="/forgot-password" className="text-xs text-[#00D4FF] hover:text-[#00BBDD] transition-colors">
                  Mot de passe oublié ?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-slate-500 text-sm mt-6">
            ...
            <Link to="/register" className="text-[#00D4FF] hover:text-[#00BBDD] font-medium transition-colors">
              S'inscrire
            </Link>
          </p>
        </div>
